                ...
                item.children ? (
                  ...
                  >
                    ...
                    {servicesOpen && (
                      <div
                        id="services-submenu"
                        role="menu"
                        className="absolute top-full left-0 mt-1 w-64 bg-white rounded-lg shadow-lg border py-2 animate-in fade-in slide-in-from-top-2 duration-200"
                      >
                  ...
                  <Link
                    ...
                    className={cn(
                      ...
                      isActive(item.href!) && "text-primary font-semibold border-b-2 border-primary"
                    )}
                  >
                    {item.label}
                  </Link>
