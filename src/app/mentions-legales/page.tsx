    ...
    <>
      ...
      <SectionContainer>
        <div className="max-w-3xl mx-auto prose prose-sm prose-slate">
          ...
          <h2 className="text-xl font-bold text-primary mt-8 mb-4">1. Éditeur du site</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-primary mt-8 mb-4">2. Hébergeur</h2>
          <p>
            Ce site est hébergé par Vercel Inc., 340 S Lemon Ave #4133, Walnut, CA 91789, USA.
          </p>

          <h2 className="text-xl font-bold text-primary mt-8 mb-4">3. Propriété intellectuelle</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-primary mt-8 mb-4">4. Protection des données personnelles (RGPD)</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-primary mt-8 mb-4">6. Crédits</h2>
          <p>
